...
class Instrument:
    ...
    def __post_init__(self) -> None:
        ...
        for field_name in ("tick_size", "lot_size", "minimum_quantity", "minimum_notional", "contract_multiplier"):
            value = decimal(getattr(self, field_name))
            if value < 0 or (field_name in {"tick_size", "lot_size", "contract_multiplier"} and value == 0):
