...
The Docker image uses `quant/runtime-requirements.txt` for the small shadow/paper runtime. Research and test tooling remains declared separately in `quant/requirements.txt`.
