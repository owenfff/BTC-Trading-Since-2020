...
def _base_event(
    ...
    event = {
        ...
        "execCommCcy": clean(row.get("execCommCcy", "")).strip(),
        "execCost": clean(row.get("execCost", "")),
        "execComm": clean(row.get("execComm", "")),
        "brokerCommission": clean(row.get("brokerCommission", "")),
        "brokerExecComm": clean(row.get("brokerExecComm", "")),
        ...
        "commission": clean(row.get("commission", "")),
        "lastLiquidityInd": clean(row.get("lastLiquidityInd", "")).strip(),
        "orderID": clean(row.get("orderID", "")).strip(),
        "ordType": clean(row.get("ordType", "")).strip(),
        "ordStatus": clean(row.get("ordStatus", "")).strip(),
        "trdMatchID": clean(row.get("trdMatchID", "")).strip(),
        ...
        "instrument_metadata_lot_size": instrument.get("lotSize", ""),
